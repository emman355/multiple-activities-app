...
export const Navbar02 = React.forwardRef<HTMLElement, Navbar02Props>(
	(
		...
		return (
			<header
				ref={combinedRef}
				className='sticky top-0 z-50 w-fullbg-gray-900/95 backdrop-blur supports-backdrop-filter:bg-gray-900/60 px-4 md:px-6 **:no-underline'
				{...props}
			>
					...
					<div className="flex items-center gap-2">
						...
						{isMobile && (
							<Popover>
								...
								<PopoverContent align="start" className='bg-gray-700 w-fit'>
									<NavigationMenu>
